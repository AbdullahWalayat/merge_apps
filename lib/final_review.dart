...
class FinalReview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Fahrenheit Converter - Abdullah Walayat'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  int n1 = 0; String output = 'Covert Kelvin to Fahrenheit';
          ...
          child: Column(
            children: [
              Padding(
                ...
                child: Text(output, style: TextStyle(fontSize: 23, fontWeight: FontWeight.w500, color: Colors.lightBlueAccent),
                ),
              ),
              TextField(decoration: InputDecoration(labelText: 'Kelvin Temp',
