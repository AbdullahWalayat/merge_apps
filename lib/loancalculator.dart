...
class LoanCalculator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyHomePage(title: 'Loan Calculator - Abdullah Walayat'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void _incrementCounter() {
    setState(() {
      ...
      else output = calc.doit(amount: amount, weekly: weekly);
              ...
              child: Column(
                children: [
                  Padding(
                    ...
                    child: TextField(style: TextStyle(fontSize: 16, color: Colors.blueGrey), textAlign: TextAlign.center,
                      keyboardType: TextInputType.number,
                      decoration: InputDecoration(labelText: 'Loan Amt',
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child: TextField(style: TextStyle(fontSize: 16), textAlign: TextAlign.center,
                      keyboardType: TextInputType.number,
                      decoration: InputDecoration(labelText: 'Weekly Amt',
                          border: OutlineInputBorder()),
                      onChanged: (text){
